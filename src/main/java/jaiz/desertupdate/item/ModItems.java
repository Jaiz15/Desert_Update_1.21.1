...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, Identifier.of(DunesDrought.MOD_ID, name), item);
    }
    ...
    public static final Item ANCIENT_HORN_01 = registerItem("ancient_horn_01", new HornItem(new Item.Settings().maxCount(1)));
    public static final Item ANCIENT_HORN_02 = registerItem("ancient_horn_02", new HornItem2(new Item.Settings().maxCount(1)));
    public static final Item ANCIENT_HORN_03 = registerItem("ancient_horn_03", new HornItem3(new Item.Settings().maxCount(1)));
